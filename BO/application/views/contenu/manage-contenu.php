...
<?php if(!empty($contenus)) {?>
  <table class="table table-hover">
    ...
    <tbody>
    <?php $i=1; foreach($contenus as $contenu) { ?>
      <tr>
        <td> <?php echo $i; ?> </td>
        ...
        <td>
        <!-- <a href="<?php echo site_url()?>change-status-contenu/<?php echo $contenu->id ?>" > <?php if($contenu->status==0){ echo "Activate"; } else { echo "Deactivate"; } ?></a> -->
